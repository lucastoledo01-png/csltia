...
function Header() {
  return (
    <header className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-5 text-sm sm:px-5 md:px-8 md:py-7 md:text-base">
      ...
      <Link className="cta-gradient rounded-full px-4 py-3 font-semibold text-white shadow-[0_12px_24px_rgba(255,74,28,0.28)] transition-transform hover:-translate-y-0.5 sm:px-6" href="#inscrever">
        inscreva-se
      </Link>
    </header>
  );
